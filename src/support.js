...
// charities.slice(0, Math.min(perPage, charities.length)).forEach(charity => {
//     createListItem(charity);
// });
...
// // // Оновимо обробник подій на кнопку для прокрутки при натисканні
// // buttonDown.addEventListener('click', () => {
// //     // Викликаємо функцію для прокрутки на висоту двох пунктів
// //     document.querySelector('.swiper-wrapper').scrollTop += 2 * document.querySelector('.swiper-slide').offsetHeight;
    
// //     // Перевіряємо, чи досягнуто кінець прокрутки
// //     const wrapper = document.querySelector('.swiper-wrapper');
// //     const button = document.querySelector('.btn-s');
    
// //     if (wrapper.scrollTop + wrapper.clientHeight >= wrapper.scrollHeight) {
// //         // Якщо досягнуто кінець прокрутки, повертаємо кнопку на 180 градусів
// //         button.style.transform = 'rotate(180deg)';
// //     } else {
// //         // Інакше повертаємо кнопку у вихідне положення
...
//     // Перевіряємо, чи досягнуто кінець списку прокрутки
//     if (wrapper.scrollTop + wrapper.clientHeight >= wrapper.scrollHeight) {
//         // Якщо досягнуто кінця списку, повертаємо кнопку на 180 градусів
//         button.style.transform = 'rotate(180deg)';
//     } else {
//         // Інакше повертаємо кнопку у вихідне положення
//         button.style.transform = 'rotate(180deg)';
...
//     if (scrollDirection === 'down') {
//         // Якщо прокрутка вниз, то перевіряємо, чи досягнуто кінця списку прокрутки
//         if (wrapper.scrollTop + wrapper.clientHeight >= wrapper.scrollHeight) {
//             // Якщо досягнуто кінця списку, прокручуємо у протилежному напрямку
//             wrapper.scrollTop -= 3 * document.querySelector('.swiper-slide').offsetHeight;
//         } else {
//             // Інакше прокручуємо вниз на висоту двох пунктів
//             wrapper.scrollTop += 3 * document.querySelector('.swiper-slide').offsetHeight;
//         }
//     } else {
//         // Якщо прокрутка вгору, то перевіряємо, чи досягнуто початку списку прокрутки
//         if (wrapper.scrollTop <= 0) {
//             // Якщо досягнуто початку списку, прокручуємо у протилежному напрямку
//             wrapper.scrollTop += 3 * document.querySelector('.swiper-slide').offsetHeight;
//         } else {
//             // Інакше прокручуємо вгору на висоту двох пунктів
//             wrapper.scrollTop -= 3 * document.querySelector('.swiper-slide').offsetHeight;
//         }
//     }
// });
