...
const charities = [
    {
        ...
        resolution: './img/save-the-children@2x.png',
    ...
    },
    {
        ...
        resolution: './img/project-hope@2x.png',
    },
    {
        title: 'UNITED24',
        url: 'https://u24.gov.ua/uk',
        img: './img/unit.png',
        resolution: './img/united24@2x.png',
    },
    {
        title: 'International Medical Corps',
        url: 'https://internationalmedicalcorps.org/country/ukraine/',
        img: './img/international-medical-corps.png',
        resolution:'./img/international-medical-corps@2x.png',
    },
    {
        title: 'Medicins Sans Frontieres',
        url: 'https://www.msf.org/ukraine',
        img: './img/medicins-sans-frontieres.png',
        resolution:'./img/medicins-sans-frontieres@2x.png',
    },
    {
        title: 'RAZOM',
        url: 'https://www.razomforukraine.org/',
        img: './img/razom.png',
        resolution:'./img/razom@2x.png',
    },
    {
        title: 'Action against hunger',
        url: 'https://www.actionagainsthunger.org/location/europe/ukraine/',
        img: './img/action-ageinst-hunger.png',
        resolution:'./img/action-against-hunger@2x.png',
    },
    {
        title: 'World vision',
        url: 'https://www.wvi.org/emergencies/ukraine',
        img: './img/world-vision.png',
        resolution:'./img/world-vision@2x.png',
    },
    {
        title: 'Serhiy Prytula Charity Foundation',
        url: 'https://prytulafoundation.org/en',
        img: './img/sergiy-prytula.png',
        resolution:'./img/serhiy-prytula-charity-foundation@2x.png',
    },
];
